...
?>
                                        <input class="xo_scrol_perc"
                                               ...
                                               min="1"
                                               value="<?php 
echo esc_attr( $wpop_scrol_perc_value );
?>">
										<?php 
                            ...
                            <div class="xo_availble_wrap">
                                <div class="xo_col_half">
                                    <div class="xo_new_head">
                                        <h1>
                                            <?php 
echo esc_html_e( "Visitor Status", 'wpoptin' );
?>
                                        </h1>
                                        </div>
                                        <p>
...
?>
                                                <span>
                                                    <?php 
echo esc_html_e( "Visitor is logged in", 'wpoptin' );
?>
                                                </span>
                                            </label>
                                            <?php 
if ( wpop_fs()->is_free_plan() ) {
                                                ...
                                                <div id="wpop-upgrade-visitor-status"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="wpop-modal-content">
                                                            ...
                                                            <h5><?php 
    echo esc_html_e( "Premium Feature", 'wpoptin' );
    ?></h5>
                                                            <p><?php 
    echo esc_html_e( "We're sorry, Visitor Status conditions are not included in your plan. Please upgrade to the premium plan to unlock this and all other cool features. Keep increase conversion by 10x while testing new ideas.", 'wpoptin' );
    ?></p>
                                                            <hr>
                                                            <p><?php 
    echo esc_html_e( "Use following coupon to get 27% discount for limited time", 'wpoptin' );
    ?>
    ...
    echo esc_html_e( "Upgrade to pro", 'wpoptin' );
    ?>
                                                            </a>
                                                        </div>
                                                    </div>
...
?>
                                                <span class="mdl-checkbox__label">
                                                    <?php 
echo esc_html_e( "Visitor is not logged in", 'wpoptin' );
?>
                                                </span>
                                            </label>
                                        </p>
                                        ...
                                        <div class="xo_col_half">
                                            <div class="xo_new_head">
                                                <h1>
                                                    <?php 
echo esc_html_e( "Device Status", 'wpoptin' );
?>
                                                </h1>
                                            </div>
                                            <p>
...
?>
                                                    <span class="mdl-checkbox__label">
                                                        <?php 
echo esc_html_e( "Only on mobile devices", 'wpoptin' );
?>
                                                    </span>
                                                </label>
                                                <?php 
if ( wpop_fs()->is_free_plan() ) {
    ...
    ?></h5>
                                                                <p><?php 
    echo esc_html_e( "We're sorry, Device Status conditions are not included in your plan. Please upgrade to the premium plan to unlock this and all other cool features. Keep increase conversion by 10x while testing new ideas.", 'wpoptin' );
    ?></p>
                                                                <hr>
                                                                <p><?php 
    echo esc_html_e( "Use following coupon to get 27% discount for limited time", 'wpoptin' );
...
?>
                                                    <span class="mdl-checkbox__label">
                                                        <?php 
echo esc_html_e( "Not on mobile devices", 'wpoptin' );
?>
                                                    </span>
                                                </label>
                                            </p>
                                            ...
                                            <div class="xo_optin_accounts_right">
                                                <div class="xo_lost_holder">
                                                    <div class="card">
                                                        ...
                                                        <h4>
                                                            <?php 
echo esc_html_e( "Feeling Lost?", 'wpoptin' );
?>
                                                        </h4>
                                                        <div class="card-content">
                                                            <a target="_blank"
                                                               href="<?php 
echo esc_url( $this->wpop_doc_url( $goal ) );
?>"
                                                               class="btn waves-effect waves-light">
                                                                <?php 
echo esc_html_e( "Check this out", 'wpoptin' );
?>
                                                            </a>
                                                        </div>
                                                    </div>
