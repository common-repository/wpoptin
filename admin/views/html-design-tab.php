...
$wpoptin_skin_title = isset($wpoptin_skin['title']) ? $wpoptin_skin['title'] : '';

$wpoptin_skin_description = isset($wpoptin_skin['description']) ? $wpoptin_skin['description'] : '';

?>
<div class="tab-content fadeIn" id="design-panel">
    <div id="xo_all_skins_wrap" class="xo_all_skins_wraper">
        <div class="row">
            <div class="card xo_skin_main_holder xo_offer_goal xo_skin_<?php echo esc_attr( $selected_skin_id )?> col s3 wpop_show_selected_label"
                 id="<?php echo esc_attr( $selected_skin_id )?>">
                <div class="card-image">
                    <img src="<?php echo esc_url( $feat_html )?>">
            ...
            <?php esc_html_e( "Selected", 'wpoptin' ); ?>
                ...
                <div class="card-content">
                    <h4>
						<?php echo esc_attr( $wpoptin_skin_title ) ?>
                    </h4>
                    <p>
						<?php echo esc_attr( $wpoptin_skin_description ); ?>
                    </p>
                </div>
                <div class="wpop-skin-actions">
                    <button type="button"
                            data-skin_id="<?php echo esc_attr( $selected_skin_id )?>"
                            class="btn waves-effect waves-light xo_skin_select disabled">
						<?php echo esc_attr( __( 'Select', 'wpoptin' ) )?>
                    </button>
                    <a href="<?php echo esc_attr( $finalUrl )?>"
