...
if ( !empty( $wpoptins_accounts ) ) {
    ...
    ?>"
                id="accounts_li"
                class="ox-accounts-li wpop-tooltipped"
...
if ( !empty( $wpoptins ) ) {
    ...
    ?>"
                id="xo_stats"
                class="xo_stats wpop-tooltipped"
                data-position="bottom"
                data-tooltip="<?php 
...
?>"
                class="ox-add-new wpop-tooltipped"
                data-position="bottom"
                data-tooltip="<?php 
...
<div class="xo-settings-genral-wrapper">
    ...
    if ( isset( $wpoptins ) ) {
        foreach ( $wpoptins as $wpoptin ) {
            ...
            <tr
                class="row_<?php 
            echo esc_attr( $wpoptin['ID'] );
            if ( isset( $wpoptin['parent_id'] ) ) {
                ?>
                 xo_child_row xo_child_of_<?php 
                echo esc_attr( $wpoptin['parent_id'] );
                ?>
                 <?php 
            }
            ?>">
            ...
            ?>
                    <?php 
            echo esc_attr( $wpoptin['title'] );
            ?>
                </td>
                <td>
                    <i
                        class="material-icons wpop-tooltipped"
                        data-position="right"
                        data-tooltip="<?php 
            echo esc_attr( $wpop_type_label );
            ?>">
                        <?php 
            echo esc_attr( $wpop_type_icon );
            ?>
                    </i>
                </td>
                <td>
            ...
            ?>">
                        ...
                        <div id="wpop-upgrade-ab-testing" class="modal wpop-upgrade-modal">
                            <div class="modal-content">
                                <div class="wpop-modal-content">
                                    <span class="wpop-lock-icon">
            ...
            echo esc_url( wpop_fs()->get_upgrade_url() );
            ?>"
                                        class="waves-effect waves-light btn z-depth-3">
                                        <i class="material-icons right">lock_open</i><?php 
            ...
            if ( isset( $wpoptin['varint_id'] ) ) {
                echo esc_attr( $wpoptin['varint_id'] );
            }
            ?>"
                            data-remove_id="<?php 
            echo esc_attr( $wpoptin['ID'] );
...
?>
                        ...
                        <a class="waves-effect waves-light btn wpop-select-goal" data-goal="optin">
...
?>
                        ...
                        <a
                            class="waves-effect waves-light btn wpop-select-goal"
...
?>
                        ...
                        <a class="waves-effect waves-light btn wpop-select-goal" data-goal="offer_bar">
                            <i class="material-icons right">chevron_right
                            </i>
                            <?php 
esc_html_e( "Select", 'wpoptin' );
            ...
            <div class="col s3 wpop-goal-holder woo-product-card">
                <div class="card">
                    <div class="card-content">
                        <h5>
                            <?php 
    esc_html_e( "Woocommerce Product", 'wpoptin' );
    ?>
                        </h5>
                        <p>
                            <?php 
    esc_html_e( "Showcase WooCommerce products.", 'wpoptin' );
    ?>
                        </p>
                        <a
                            class="waves-effect waves-light btn wpop-select-goal"
                            ...
                            <?php 
    echo esc_html( esc_html_e( "Select", 'wpoptin' ) );
    ?>
                        </a>
                    </div>
                </div>
    ...
    ?>
            <div class="col s3 wpop-goal-holder woo-product-card">
                <div class="card">
                    ...
                    <div id="wpop-activate-woocommerce" class="modal wpop-upgrade-modal">
                        <div class="modal-content">
                            <div class="wpop-modal-content">
                                <h5><?php 
    echo esc_html( esc_html_e( "WooCommerce is currently inactive.", 'wpoptin' ) );
    ?></h5>
                                <p><?php 
    echo esc_html( esc_html_e( "The WooCommerce plugin is presently not activated. Please activate the plugin. If you haven't installed the plugin yet, you can download it using the link provided below.", 'wpoptin' ) );
    ?></p>
                                <a
                                    href="<?php 
    echo esc_url( esc_html( 'https://wordpress.org/plugins/woocommerce/' ) );
    ?>"
                                    target="_blank"
                                    class="waves-effect waves-light btn z-depth-3">
                                    <i class="material-icons right">chevron_right
                                    </i><?php 
    echo esc_html( esc_html_e( "Get Woocommerce", 'wpoptin' ) );
    ?>
                                </a>
                    ...
                    <div class="card-content">
                        <h5>
                            <?php 
    echo esc_html( esc_html_e( "Woocommerce Product", 'wpoptin' ) );
    ?>
                        </h5>
                        <p>
                            <?php 
    echo esc_html( esc_html_e( "Showcase WooCommerce products.", 'wpoptin' ) );
    ?>
                        </p>
                        <a
                            href="<?php 
            ...
            <div class="col s3 wpop-goal-holder">
                <div class="card">
                    <div class="card-content">
                        <h5>
                            <?php 
echo esc_html( esc_html_e( "Custom", 'wpoptin' ) );
?>
                        </h5>
                        <p>
                            <?php 
echo esc_html( esc_html_e( "Not sure? Use our custom module according to your requirements and imagination.", 'wpoptin' ) );
?>
                        </p>

                        <a class="waves-effect waves-light btn wpop-select-goal" data-goal="custom">
                            <i class="material-icons right">chevron_right
                            </i>
                            <?php 
echo esc_html( esc_html_e( "Select", 'wpoptin' ) );
?>
    ...
    <div class="wpop-types-holder row wpop-goals-holder">
        <h4>
            <?php 
echo esc_html( esc_html_e( "Choose type", 'wpoptin' ) );
?>
        </h4>
...
?>/assets/images/wpop-bar-icon.svg">
                ...
                <div class="card-content">
                    <h5>
                        <?php 
echo esc_html( esc_html_e( "Bar", 'wpoptin' ) );
?>
                    </h5>
                    <p>
                        <?php 
echo esc_html( esc_html_e( "A scrolling bar at the top of your site to increase conversion.", 'wpoptin' ) );
?>
                    </p>
                    <a
                        class="waves-effect waves-light btn wpop-select-type"
                        data-href="<?php 
echo esc_url( esc_html( admin_url( 'admin.php?page=wpop_new&goal=' ) ) );
?>"
                        data-type="bar">
                        <i class="material-icons right">chevron_right
                        </i>
...
?>/assets/images/wpop-popup-icon.svg">
                ...
                <div class="card-content">
                    <h5>
                        <?php 
echo esc_html( esc_html_e( "Lightbox popup", 'wpoptin' ) );
?>
                    </h5>
                    <p>
                        <?php 
echo esc_html( esc_html_e( "A pop up or modal window in the center of your site. Very popular and very effective.", 'wpoptin' ) );
?>
                    </p>
                    <a
                        class="waves-effect waves-light btn wpop-select-type"
...
?>/assets/images/wpop-slidein-icon.svg">
                ...
                <div class="card-content">
                    <h5>
                        <?php 
echo esc_html( esc_html_e( "Slide In", 'wpoptin' ) );
?>
                    </h5>
                    <p>
                        <?php 
echo esc_html( esc_html_e( "Alternative to PopUp and less distracting but still highly converting slide in box in the corner of your site..", 'wpoptin' ) );
?>
                    </p>
                    <a
                        class="waves-effect waves-light btn wpop-select-type-new"
                        data-href="<?php 
...
?>/assets/images/wpop-welcome-matt-icon.svg">
                    ...
                    <div class="card-content">
                        <h5>
                            <?php 
echo esc_html( esc_html_e( "Wellcome Matt", 'wpoptin' ) );
?>
                        </h5>
                        <p>
                            <?php 
echo esc_html( esc_html_e( "A full site screen take over with your selected goal which can’t be ignored.", 'wpoptin' ) );
?>
                        </p>
                        <a
                            class="waves-effect waves-light btn wpop-select-type-new"
...
<div class="wpoptin-upgrade-wrapper z-depth-2">
    <h2><?php 
        if ( isset( $banner_info['name'] ) ) {
            echo esc_html( $banner_info['name'] );
        }
        ?>
        <b><?php 
        if ( isset( $banner_info['bold'] ) ) {
            echo esc_html( $banner_info['bold'] );
        }
        ?></b>
    </h2>
    <p><?php 
        if ( isset( $banner_info['description'] ) ) {
            echo esc_html( $banner_info['description'] );
        }
        ?></p>
    <p><?php 
        if ( isset( $banner_info['discount-text'] ) ) {
            echo esc_html( $banner_info['discount-text'] );
        }
        ?>
        <code><?php 
        if ( isset( $banner_info['coupon'] ) ) {
            echo esc_html( $banner_info['coupon'] );
        }
        ?></code>
    </p>
    <a
        ...
        if ( isset( $banner_info['button-text'] ) ) {
            echo esc_html( $banner_info['button-text'] );
        }
        ?>
    </a>
</div>
