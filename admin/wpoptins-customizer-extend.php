...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Customize_Alpha_Color_Control' ) ):
	class Customize_Alpha_Color_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'alpha-color-picker', esc_url( WPOP_URL . 'assets/js/alpha-color-picker.js' ), [
					'jquery',
					'wp-color-picker',
				], '1.0.0', true );
			wp_enqueue_style( 'alpha-color-picker', esc_url( WPOP_URL . 'assets/css/alpha-color-picker.css' ), [ 'wp-color-picker' ], '1.0.0' );
		}
		...
		public function render_content() {
			...
			if ( is_array( $this->palette ) ) {
				$palette = implode( '|', array_map( 'esc_attr', $this->palette ) );
			} else {
				// Default to true.
	...
	class WPOPTIN_Background_Image_Upgrade extends WP_Customize_Control {
		...
		public function render_content() {
            ...
            <div class="attachment-media-view">
                <button type="button"
                        class="wpop-bg-image-upload button-add-media"><?php echo esc_html( __( 'Select image', 'wpoptin' ) ) ?></button>
            </div>
            ...
            <div class="wpop-bg-image-upgrade-wrap">
                ...
                <a href="<?php echo esc_url( wpop_fs()->get_upgrade_url() ) ?>"
                   class="wpoptin-upgrade-btn"><?php echo esc_html( __( 'Upgrade to pro', 'wpoptin' ) ) ?></a>
            </div>
		...
		public function render_content() {
            ...
            <span class="customize-inside-control-row customize-inside-positon-control-row">
                <input id="wopop-position-left"
                       ...
                       type="radio">
                <label for="wopop-position-left"><?php echo esc_html( __( 'Left', 'wpoptin' ) ) ?></label>
            ...
            <span class="customize-inside-control-row customize-inside-positon-control-row">
                <input id="wopop-position-right"
                       ...
                       type="radio">
                <label for="wopop-position-right"><?php echo esc_html( __( 'Right', 'wpoptin' ) ) ?></label>
                 <div class="wpop-position-upgrade-wrap">
            ...
            <span class="customize-inside-control-row customize-inside-positon-control-row">
                <input id="wopop-position-center"
                       ...
                       type="radio">
                <label for="wopop-position-center"><?php echo esc_html( __( 'Bottom Center', 'wpoptin' ) ) ?></label>
