...
<div class="input-field col s12">
    <input id="wpop_new_offer_btn_text" type="text"
           value="<?php echo esc_attr( $btn_text )?> " name="wpop_new_offer_btn_text"
           required>
...
<div class="input-field col s12">
    ...
    <select id="wpop_calls_country" name="wpop_country_code">
		...
		foreach ( $wpop_countries_list as $code => $country ) {
            ...
            <option value="<?php echo esc_attr( $country['code'] ); ?>" <?php if ( $country['code'] == $country_code ): ?> selected <?php endif; ?> > <?php echo esc_attr( $countryName ); ?>
...
<div class="input-field col s12">
    <input id="wpop_new_offer_btn_url" type="text"
           value="<?php echo esc_attr( $WPOptins->wpop_get_settings( $wpoptin_id, 'offer-btn-url', false, false, $is_child ) ?? '' )?>"
