...
if ( !class_exists( 'WPOPTIN' ) ) {
    class WPOPTIN {
        ...
        function __construct() {
            ...
            add_action( 'plugins_loaded', [$this, 'wpop_load_textdomain'] );
        }
        ...
        public function wpop_activate() {
            ...
            add_option( 'wpoptins_installDate', gmdate( 'Y-m-d h:i:s' ) );
            $data = [
         ...
         * */
        public function wpop_load_textdomain() {
            load_plugin_textdomain( 'wpoptin', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
        }
