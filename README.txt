...
Contributors: maltathemes, wpoptin, usamamaltathemes, sjaved, freemius
Tags: top-bar, exitintent, popup, bar, Opt-in
...
An easy to use top bar and popups plugin to increase sales, subscribers, phone calls, and leads using exit intent, time interval and scroll techniques.  
...
DEMOS:
- [Optin](https://wpxoptin.com/optin/)
- [Sales and offers](https://wpxoptin.com/sales-promotions-and-discount-offers/)
- [Click to call](https://wpxoptin.com/click-to-call/)
- [Annoucments - For example Corona Update](https://wpxoptin.com/announcements/)
- [Social traffic](https://wpxoptin.com/social-traffic/)
- [WooCommerce Products](https://wpxoptin.com/woo-products/)
...
[ericnd](https://wordpress.org/support/topic/works-perfectly-helpful-support/)
...
- Goals - Well, you have a specific goal in your mind. Right? This plugin makes it easy to achieve that goal. With this plugin you can achieve following goals (but not only):
    - [Optin](https://wpxoptin.com/wpoptin-popup/) - Convert visitors into subscribers by using optin forms.
    - [Click to Call](https://wpxoptin.com/phone-calls-bar/) - Display a prominent click to call button to get more calls for reservations, appointments, bookings and leads.
    - [Offer bar](https://wpxoptin.com/sales-promotions-and-discount-offers-bar/) - Promote special offers and holiday sales.
    - [Announcements](https://wpxoptin.com/announcement-bar/) - Got something to announce? Display important updates, announcements and news of your site with ease.
    - [Social traffic](https://wpxoptin.com/social-traffic-bar/) - increase social traffic by displaying Facebook like buttons or a Facebook fan page.
    - [Custom campaign](https://wpxoptin.com/custom-popup/) - Not sure? Use our custom module according to your requirements and display anything.
    - [WooCommerce Products](https://wpxoptin.com/woo-products/) - Effortlessly showcase your products with our WooCommerce Products module, designed to enhance the visual appeal and promotional flexibility of your online store.
    - More - Coming soon for example Cookies consent.
- Types:
    - [PopUp](https://wpxoptin.com/wpoptin-popup/) - A pop up or modal window in the center of your site. Very popular and very effective. Alternately also called lightbox.
    - [Bar](https://wpxoptin.com/sales-promotions-and-discount-offers-bar/) - A scrolling bar at the top of your site to increase conversion.
...
[Premium features](https://wpxoptin.com/pricing/)
...
Highly Recommended!" 
[daniyalahmedk](https://wordpress.org/support/topic/excellent-plugin-5590/)
...
Yes, it is indeed the best alternative available on WordPress.org repository with free features of Exit-Intent, conditions and number of types like PopUp, SlideIn, Bar and Welcome Mat (more coming soon). Above, it has clean code, attractive design, free to install and no need to connect with third party services.
...
== Screenshots ==
1. Collect Emails in Lightbox Popup.
2. Sales, promotions and discount offers in Lightbox Popup.
3. Facebook Likebox/Page plugin in Lightbox Popup.
4. Phone calls in Lightbox Popup.
5. Announcement in Lightbox Popup.
6. Custom module in Lightbox Popup.
7. Collect Emails in bar.
8. Change design in live preview.
9. Sales, promotions and discount offers in bar.
10. Phone calls in bar.
11. Simple announcement bar.
12. Social like button.
13. Total Analytics data.
14. Views and conversion per day in graph.
15. Select any goal.
16. How you want to display?
17. Optin service provide integration
18. Optin content
19. Phone calls content
20. Sales, promotions and discount offers content
21. Social traffic content
22. Advanced display conditions
23. User status conditions
24. Advanced triggers options
25. Customise design settings in live preview
26. Announcement content
27. Custom module content with rich editor
28. Accounts management            
...
== Upgrade Notice ==
= 1.2.5 =
Must update the plugin to make it work with latest version of WordPress 6.2
