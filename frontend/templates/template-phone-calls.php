...
switch ( $type ) {
    case 'popup':
        ...
        $feat_img = esc_url( $WPOptins->wpop_get_settings(
            $xoptin_id,
            'feat_img',
            false,
            false,
    ...
    <div class="xo_front_c">
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                ...
                <p><?php 
            echo esc_html( apply_filters( 'wpop_phone_calls_popup_content', $content, $instance ) );
            ?></p>
        ...
        echo esc_attr( apply_filters( 'wpop_phone_calls_popup_button_url', $WPOptins->wpop_get_settings(
            $xoptin_id,
            'offer-btn-url',
            false,
            false,
...
<div class="wppop-wellcome-matt-container">
    <div class="wppop-wellcome-matt-inner">
        ...
        echo esc_html( $WPOptins->wpop_get_settings(
            $xoptin_id,
            'offer-btn-text',
            false,
            false,
...
<div class="xo_front_c">
    <div class="xo_offer_c_wrap">
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                ...
                <p><?php 
            echo esc_html( apply_filters( 'wpop_phone_calls_slide_in_content', $content, $instance ) );
            ?></p>
    ...
    <div class="xo_offer_btn">
        ...
        echo esc_attr( apply_filters( 'wpop_phone_calls_slide_in_button_url', $WPOptins->wpop_get_settings(
            $xoptin_id,
            'offer-btn-url',
            false,
            false,
...
<div class="xo_front_c">
    ...
    <div class="xo_offer_c_wrap">
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                ...
                <p><?php 
            echo esc_html( apply_filters( 'wpop_phone_calls_bar_content', $content, $instance ) );
            ?></p>
    ...
    <div class="xo_offer_btn">
        ...
        echo esc_attr( apply_filters( 'wpop_phone_calls_bar_button_url', $WPOptins->wpop_get_settings(
            $xoptin_id,
            'offer-btn-url',
            false,
            false,
