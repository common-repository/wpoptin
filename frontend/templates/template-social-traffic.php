            ...
            case 'fb_likebox':
                if ( isset( $content ) && !empty( $content ) ) {
                    ...
                    ?>
                                ...
                                <p><?php 
                    echo esc_url( apply_filters( 'wpop_social_traffic_popup_content', $content, $instance ) );
                    ?></p>
            ...
            case 'custom':
                if ( isset( $content ) && !empty( $content ) ) {
                    ...
                    ?>
                                ...
                                <p><?php 
                    echo esc_html( apply_filters( 'wpop_social_traffic_popup_content', $content, $instance ) );
                    ?></p>
            ...
            case 'fb_likebox':
                ...
                if ( isset( $content ) && !empty( $content ) ) {
                    ...
                    ?>
										...
										<p><?php 
                    echo esc_html( apply_filters( 'wpop_social_traffic_wellcome_matt_content', $content, $instance ) );
                    ?></p>
        ...
        switch ( $url_type ) {
            case 'fb_likebox':
				...
				<div class="xo_offer_c">
					...
					<p><?php 
                    echo esc_html( apply_filters( 'wpop_social_traffic_slide_in_content', $content, $instance ) );
                    ?></p>
    ...
    default:
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
								...
								<p><?php 
            echo esc_html( apply_filters( 'wpop_social_traffic_bar_content', $content, $instance ) );
            ?></p>
