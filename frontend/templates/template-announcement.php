    ...
    case 'popup':
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                        ...
                                        <p><?php 
            echo esc_html( apply_filters( 'wpop_announcement_popup_content', $content, $instance ) );
            ?></p>
    ...
    case 'wellcome_matt':
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                        ...
                                        <p><?php 
            echo esc_html( apply_filters( 'wpop_announcement_wellcome_matt_content', $content, $instance ) );
            ?></p>
    ...
    case 'slide_in':
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                ...
                                <p><?php 
            echo esc_html( apply_filters( 'wpop_announcement_slide_in_content', $content, $instance ) );
            ?></p>
    ...
    default:
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                ...
                                <p><?php 
            echo esc_html( apply_filters( 'wpop_announcement_bar_content', $content, $instance ) );
            ?></p>
