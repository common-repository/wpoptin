...
?> <?php 
echo esc_attr( $wpop_timer_enabled );
?> xo_<?php 
    ...
    case 'popup':
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                    ...
                                    <p><?php 
            echo esc_html( apply_filters( 'wpop_optin_popup_content', $content, $instance ) );
            ?></p>
    ...
    case 'wellcome_matt':
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                        ...
                                        <p><?php 
            echo esc_html( apply_filters( 'wpop_optin_wellcome_matt_content', $content, $instance ) );
            ?></p>
    ...
    case 'slide_in':
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                                        ...
                                                        <p><?php 
            echo esc_html( apply_filters( 'wpop_optin_slide_in_content', $content, $instance ) );
            ?></p>
        ...
        ?>
                                                        ...
                                                        <input type="email" name="xo_newsletter_email"
                                                               ...
                                                               placeholder="<?php 
        echo esc_attr( apply_filters( 'wpop_optin_slide_in_email_placeholder', $placeholder, $instance ) );
        ?>">
                                                        </input>
        ...
        ?>
                                                        ...
                                                        <input type="submit"
                                                               value="<?php 
        echo esc_attr( apply_filters( 'wpop_optin_slide_in_button_text', $btn_text, $instance ) );
        ?>"
                                                               class="xo_newsletter_sub">
    ...
    default:
        ...
        if ( isset( $content ) && !empty( $content ) ) {
            ...
            ?>
                                                        ...
                                                        <p><?php 
            echo esc_html( apply_filters( 'wpop_optin_bar_content', $content, $instance ) );
            ?></p>
        ...
        ?>
                                                        ...
                                                        <input type="email" name="xo_newsletter_email"
                                                               required class="xo_newsletter_email"
                                                               placeholder="<?php 
        echo esc_attr( apply_filters( 'wpop_optin_bar_email_placeholder', $placeholder, $instance ) );
        ?>">
                                                        </input>
        ...
        ?>
                                                        ...
                                                        <input type="submit"
                                                               value="<?php 
        echo esc_attr( apply_filters( 'wpop_optin_bar_button_text', $btn_text, $instance ) );
        ?>"
                                                               class="xo_newsletter_sub">
