...
defined('CS_REST_WRAPPER_VERSION') or define('CS_REST_WRAPPER_VERSION', '7.1.0');
    ...
    class CS_REST_Wrapper_Base {
        ...
        function refresh_token() {
            ...
            if ($result->was_successful()) {
                ...
                trigger_error(
                    'Error refreshing token. '.esc_html($result->response->error) .': '.esc_html($result->response->error_description),
                    E_USER_ERROR);
                return array(NULL, NULL, NULL);
            }
        }
